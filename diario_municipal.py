...
class Municipio:
    ...
    def __init__(self, municipio):
        ...
        municipio = re.sub("(\/PB.*|GABINETE DO PREFEITO.*|PODER.*|http.*|PORTARIA.*|Extrato.*|ATA DE.*|SECRETARIA.*|Secretaria.*|Fundo.*|SETOR.*|ERRATA.*|- PB.*|GABINETE.*|RATIFICAÇÃO.*)", "", municipio)
